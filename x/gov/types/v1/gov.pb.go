...
func (m *TallyParams) GetDepositLockingPeriod() time.Duration {
	if m != nil {
		return m.DepositLockingPeriod
	}
	return 0
}
...
var fileDescriptor_e05cb1c0d030febb = []byte{
	...
	,
}
...
func (m *TallyParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n8, err8 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.DepositLockingPeriod, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.DepositLockingPeriod):])
	if err8 != nil {
		return 0, err8
	}
	i -= n8
